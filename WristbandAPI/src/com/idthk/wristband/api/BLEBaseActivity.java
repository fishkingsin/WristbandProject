...
//    protected BluetoothDevice  = null;
    ...
    private ServiceConnection mServiceConnection = new ServiceConnection() {
        public void onServiceConnected(ComponentName className,
                                       IBinder rawBinder) {
            mService = ((WristbandBLEService.LocalBinder) rawBinder).getService();
...
//                                    device.getAddress());
//                        	
//                        	Log.v(TAG,"Device Name : "+ device.getName().charAt(0));
...
//                    });
                ...
                case WristbandBLEService.BLE_STREAM_MSG:
                	final byte[] value_ = data.getByteArray(WristbandBLEService.EXTRA_VALUE);
                    ...
                    runOnUiThread(new Runnable() {
                        public void run() {
                            try {
                            	if(value_.length == 19)
                            	{
                            		int steps = (value_[1] * 10000) + (value_[2] * 100) + value_[3];
                            		int calories = (value_[7] * 10000) + (value_[8] * 100) + value_[9];
...
//                            		int activityLevel = value_[15];
                ...
                case WristbandBLEService.BLE_VALUE_MSG:
                    ...
                    final byte[] value = data.getByteArray(WristbandBLEService.EXTRA_VALUE);
                        ...
                        public void run() {
                            try {
                    			...
                    			if(ret ==  WristbandBLEService.DEVICE_RETURN_TIME)
                    			{
                    				...
                    				onReadTime((2000+value[dataStart]),value[dataStart + 1],value[dataStart + 2],value[dataStart + 3],value[dataStart + 4],value[dataStart + 5],value[dataStart + 6]);
                    			}
                    			else if(ret ==  WristbandBLEService.DEVICE_RETURN_PROFILE)
                    			{
                    				onReadProfile(value[dataStart],(value[dataStart + 1]+1914),(value[dataStart + 2]),(value[dataStart + 3]+20),(value[dataStart + 4]+69));
                    			}
                    			else if(ret ==  WristbandBLEService.DEVICE_RETURN_TARGET)
                    			{
                    				int steps = (value[dataStart + 2] * 10000) + (value[dataStart + 3] * 100) + value[dataStart + 4];
                    				int calories = (value[dataStart + 6] * 10000) + (value[dataStart + 7] * 100) + value[dataStart + 8];

                    				onReadTarget(value[dataStart] ,value[dataStart + 1] , steps, value[dataStart + 5],	calories);
                    			}
                    			else if(ret ==  WristbandBLEService.DEVICE_RETURN_SLEEP)
                    			{
                    				onReadSleep(value[dataStart],value[dataStart + 1],value[dataStart + 2],value[dataStart + 3],value[dataStart + 4]);
...
//                    runOnUiThread(new Runnable() {
//                        public void run() {
//                            if ( != null && RemoteRssidevice != null
//                                    && .equals(RemoteRssidevice)) {
//                                if (rssi != 0) {
//                                    
//                                }
//                            }
...
//                    });
                ...
                case WristbandBLEService.BLE_WRITE_REQUEST_MSG: {
                    final byte[] value1 = data.getByteArray(WristbandBLEService.EXTRA_VALUE);
                ...
                case WristbandBLEService.BLE_SERVICE_DISCOVER_MSG: {
            		...
            		runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            mService.EnableDeviceNoti( WristbandBLEService.PE128_SERVICE, WristbandBLEService.PE128_CHAR_RCVD);
                    		try {
                    			Thread.sleep(1000);
                    		} catch (InterruptedException e) {
                    			// TODO Auto-generated catch block
                        	...
                        	mService.EnableDeviceNoti( WristbandBLEService.PE128_NOTI_SERVICE, WristbandBLEService.PE128_CHAR_STREAMING);
                        }
                    });
...
//                }
            ...
            if (action.equals(BluetoothAdapter.ACTION_STATE_CHANGED)) {
				...
				Log.v(TAG, "BluetoothAdapter.ACTION_STATE_CHANGED" + "state is"+ state);
//                runOnUiThread(new Runnable() {
//                    public void run() {
//                        if (state == STATE_OFF) {
//                            
...
//                                	disconnect();
	...
	// wristband specify function
		...
		public void startStream() {
			mService.WriteDevice( WristbandBLEService.PE128_SERVICE, WristbandBLEService.PE128_CHAR_XFER,
		...
		public void setTime( int year, int month, int day,
			...
			mService.WriteDevice( WristbandBLEService.PE128_SERVICE,  WristbandBLEService.PE128_CHAR_XFER, data);
		}
		...
		public void setSleep( int weekday_weak_hour, int weekday_weak_minute, int weekend_weak_hour,
				int weekend_weak_minute , int toggle) {
		...
		public void setTarget( int duration, int togggle, int step,
				int distance, int calories) {
		...
		public void getVersion() {
			...
			mService.WriteDevice( WristbandBLEService.PE128_SERVICE,  WristbandBLEService.PE128_CHAR_XFER,  WristbandBLEService.TEST_VERSION_PREFIX);
		}
		public void setDemand() {
			
			mService.WriteDevice( WristbandBLEService.PE128_SERVICE,  WristbandBLEService.PE128_CHAR_XFER,  WristbandBLEService.SET_DEMAND_PREFIX);
		}
...
//	}
	...
	public void onReadTime(int year, int month, int day, int hour, int minute, int second, int weekday)
	{
		String s = "";
	...
	public void onReadProfile(int gender, int year,
			byte month, int weight, int height) {
		// TODO Auto-generated method stub
		String s = "";
	...
	public void onReadSleep(int weekday_hour, int weekday_minute, int weekend_hour, int weekend_minute, int toggle) {
		// TODO Auto-generated method stub
		String s = "";
	...
	public void onReadTarget(int duration, int toggle, long step, int distance, int calories) {
		// TODO Auto-generated method stub
		String s = "";
